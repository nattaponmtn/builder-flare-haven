            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div
                    className={`p-2 rounded-lg ${metric.color === "text-destructive" ? "bg-destructive/10" : metric.color === "text-success" ? "bg-success/10" : metric.color === "text-warning" ? "bg-warning/10" : "bg-primary/10"}`}
                  >
          ...
          <div className="p-4 sm:p-6 space-y-3">
            {recentWorkOrders.map((wo, index) => (
              <Link key={wo.id} to={`/work-orders/${wo.id}`}>
                <div
                  className={`group cursor-pointer p-4 rounded-lg border hover:border-primary/50 transition-all duration-200 ${index === 0 ? "bg-gradient-to-r from-primary/5 to-transparent" : "hover:bg-muted/30"}`}
                >
