...
import { Bell, X, AlertTriangle, CheckCircle, Clock, Settings } from "lucide-react";
...
export function NotificationBell() {
  ...
  const totalAlerts = metrics.overdueWorkOrders + metrics.pendingWorkOrders + criticalAlertsCount;
